...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    header("Location: evaluation_detail_report.php?semester_id=$semester_id&course_id=$course_id");
    exit();
}
...
<body>
    <div class="container">
        ...
        <form action="generate_reports.php" method="POST">
            ...
            <button type="submit" class="menu-btn">تقرير</button>
        </form></div>
